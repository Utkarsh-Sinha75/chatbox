//this is used to create function to ensure that the user remains logged in if he closes and reopens the app
// shared preferences was first installed using pub.dev and then used here
